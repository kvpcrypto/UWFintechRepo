...
print("The total number of loans in the list is", total_number_loans)
...
print(f"The future value of the loan is {future_value} and there are {remaining_months} remaining months on the loan")
